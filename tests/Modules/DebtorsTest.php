...
class DebtorsTest extends TestCase
{
    ...
    {
        $result = (new Debtors())->process($this->makeProvider([]), self::makePeriod());
    ...
    public function testCountsDebtorsByCompany(): void
    {
        ...
        $result = (new Debtors())->process($this->makeProvider($invoices), self::makePeriod());
    ...
    public function testProviderExceptionReturnsFailed(): void
    {
        ...
        $result = (new Debtors())->process($mock, self::makePeriod());
