...
class OutcomingInvoicesTest extends TestCase
{
    ...
    {
        $result = (new OutcomingInvoices())->process($this->makeProvider([]), $this->makePeriod());
    ...
    public function testCountsActiveAndCancelled(): void
    {
        ...
        $result = (new OutcomingInvoices())->process($this->makeProvider($invoices), $this->makePeriod());
    ...
    public function testProviderExceptionReturnsFailed(): void
    {
        ...
        $result = (new OutcomingInvoices())->process($mock, $this->makePeriod());
